...
export function StarButton() {
  ...
  return (
    <motion.a
      href="https://github.com/shubhamgiri2004"
      target="_blank"
      rel="noopener noreferrer"
      className="inline-flex items-center px-3 py-1.5 rounded-full bg-neutral-800 shadow-md border-neutral-700 text-sm font-medium text-neutral-200 transition-all"
